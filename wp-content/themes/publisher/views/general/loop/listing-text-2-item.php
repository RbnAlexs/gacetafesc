...
?>
	<<?php echo $section_tag; ?><?php publisher_attr( 'post', publisher_get_prop_class() . ' listing-item listing-item-text listing-item-text-2 ' . $main_term_class ); ?>>
	<div class="item-inner">
		...
		if ( $ranking ) {
			publisher_listing_rank_badge( $ranking, 't2-s2' );
		}
