...
$thumbnail_size = publisher_get_prop_thumbnail_size( $thumbnail_size );
...
<div class="content-wrap">
	...
	<main <?php publisher_attr( 'content', '' ); ?>>
		...
		<div class="container <?php echo $layout_setting['container']; // escaped before ?> post-template-11">
			<?php
						...
						<div class="<?php echo $column['class']; ?>">
							<div class="single-container">
								<article <?php publisher_attr( 'post', 'single-post-content' ); ?>>
									<div
											class="post-header post-tp-11-header <?php echo ! empty( $img['src'] ) ? 'bs-lazy wfi' : 'nfi'; ?>" <?php

									if ( ! empty( $img['src'] ) ) {
										publisher_the_thumbnail_attr( array(
											'size' => $thumbnail_size,
										) );
									}
