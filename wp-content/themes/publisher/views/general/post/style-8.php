...
<div class="content-wrap">
	...
	<main <?php publisher_attr( 'content', '' ); ?>>
		...
		<div class="container <?php echo $layout_setting['container']; // escaped before ?> post-template-8">
							...
							<div class="single-container">
								...
								<article <?php publisher_attr( 'post', 'single-post-content' ); ?>>
									...
									<div <?php publisher_attr( 'post-content', 'clearfix single-post-content' ); ?>>
										...
										if ( ! empty( $img['src'] ) ) { ?>
											<div
													class="post-header post-tp-8-header bs-lazy" <?php
											publisher_the_thumbnail_attr( array(
												'size'             => $thumbnail_size,
												'smart_image_size' => false
											) )
											?>>
												<?php
												...
												if ( empty( $credit ) && ! empty( $img['caption'] ) ) {
													$credit = $img['caption'];
												}
