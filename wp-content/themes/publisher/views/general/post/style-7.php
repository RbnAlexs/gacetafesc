...
<main <?php publisher_attr( 'content', '' ); ?>>
	...
	?>
	<div
			class="post-header post-tp-7-header <?php echo ! empty( $img['src'] ) ? 'bs-lazy wfi' : 'nfi'; ?>" <?php ! empty( $img['src'] ) ? publisher_the_thumbnail_attr( $thumbnail_size ) : ''; ?>>
			...
			<div class="container">
				<div class="post-header-inner">
					<div class="post-header-title">
						...
						// Shows breadcrumb or cat badges
						if ( publisher_show_breadcrumb() ) {
							Better_Framework()->breadcrumb()->generate( array(
								'custom_class' => 'hide_current'
							) );
						} elseif ( $post_settings['term'] || $post_settings['format-icon'] ) {
	...
	<div class="content-wrap">
		...
		?>
		<div class="container <?php echo $layout_setting['container']; // escaped before ?> post-template-7">
