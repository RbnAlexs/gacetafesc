...
<main <?php publisher_attr( 'content', '' ); ?>>
	...
	<div class="content-wrap">
			...
			<div class="content-wrap">
				<div class="container">
					<div class="post-header-inner">
						...
						// Above Post Ad
						publisher_show_ad_location( 'post_box_above', array( 'container-class' => 'adloc-above-post-box adloc-above-post-box-tmargine2' ) );
						...
						<div class="single-featured <?php if ( $post_format === 'video' && ! empty($embed['content']) ) { echo 'single-featured-video'; }?>">
							<?php
		...
		?>
		<div class="container <?php echo $layout_setting['container']; // escaped before ?> post-template-15">
