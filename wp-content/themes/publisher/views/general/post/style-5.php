...
<div class="content-wrap">
	...
	<main <?php publisher_attr( 'content', '' ); ?>>
		...
		<div class="container <?php echo $layout_setting['container']; // escaped before ?> post-template-5">
			<?php
			...
			?>
			<div
					class="post-header post-tp-5-header <?php echo ! empty( $img['src'] ) ? 'bs-lazy wfi' : 'nfi'; ?>" <?php ! empty( $img['src'] ) ? publisher_the_thumbnail_attr( $thumbnail_size ) : ''; ?>>
