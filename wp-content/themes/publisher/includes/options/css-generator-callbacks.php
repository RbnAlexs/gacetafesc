		...
		$block[8] = array(
			...
			'selector'        =>
				array(
					...
					7  => '.vc_row-has-fill .wpb_wrapper > .bsac:last-child',
					8  => '.vc_col-has-fill .wpb_wrapper > .bsac:last-child',
...
//						$block['sh_bg']['selector'][] = "$block_class_imp $term_class.section-heading.sh-t3.sh-s9:before";
					...
					$block['sh_bg_imp']['selector']['tp_3_0'] = ".bsb-have-heading-color$block_class_imp $term_class.section-heading.sh-t3.sh-s9:after";
					$block['sh_bg_imp']['selector']['tp_3_0'] = "$block_class_imp $term_class.section-heading.sh-t3.sh-s9:after";
				}
