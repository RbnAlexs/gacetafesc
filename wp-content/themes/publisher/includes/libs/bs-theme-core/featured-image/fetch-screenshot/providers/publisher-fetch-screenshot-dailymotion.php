...
/**
 * Generate's screenshot for Daily Motion videos
 *
 * Class Publisher_Fetch_Screenshot_DailyMotion
 */
class Publisher_Fetch_Screenshot_DailyMotion implements Publisher_Fetch_Screenshot_Service_Interface {
	...
	public function fetch_screenshot( $video_url ) {
		...
		$api    = 'https://api.dailymotion.com/video/' . $video_id . '?fields=thumbnail_url';
